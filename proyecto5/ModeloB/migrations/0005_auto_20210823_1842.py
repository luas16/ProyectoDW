...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('ModeloB', '0004_auto_20210823_1721'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cate', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ModeloB.category')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cli', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ModeloB.client')),
            ],
            options={
                'verbose_name': 'Venta',
        ...
        migrations.AddField(
            model_name='detsale',
            name='prod',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ModeloB.product'),
        ),
        migrations.AddField(
            model_name='detsale',
            name='sale',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='ModeloB.sale'),
        ),
    ]
